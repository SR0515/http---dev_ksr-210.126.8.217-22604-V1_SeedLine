<script lang="ts">
    ...
    let currentPage = 'S_settlement_list';
    let classify = 0;
    ...
    function navigateTo(page: string) {
        if (page === 'S_settlement_list_detail') {
            goto('/settlement/store/detail');
        }
    }
                ...
                <tr>    
                    ...
                    {#if classify === 0 || classify === 2}
                        <td class="settle_title">
                            <a href="javascript:void(0)" on:click|preventDefault={() => navigateTo('S_settlement_list_detail')}>2023년 03월 20일 매출 정산내역</a>
                        </td>
                    {:else if classify === 1}
                        <td class="settle_title">
                            <a href="javascript:void(0)" on:click|preventDefault={() => navigateTo('S_settlement_list_detail')}>2023년 03월 20일 매출 정산내역</a>
