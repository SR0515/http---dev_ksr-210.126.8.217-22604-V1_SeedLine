<script lang="ts">
	...
	import '$lib/styles/commission.css';
	import '$lib/styles/add.css';
	import '$lib/styles/sub.css';
	...
	onMount(() => {
		...
		if (currentPath === '/payment/receipt') {
			goto('/payment/receipt');
			return;
		}
...
{#if currentPath !== '/payment/paymentList'}
<div class="app">
	<main>
		<slot />
		<Footer />
