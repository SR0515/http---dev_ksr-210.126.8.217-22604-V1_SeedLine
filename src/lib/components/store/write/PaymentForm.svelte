<script lang="ts">
    ...
    export let userData = getDefaultStoreListData();
                ...
                <div class="row store_edit_row" id="store_edit_row">
                    ...
                    <div class="col-12 col-md-5 col-lg-5">
                        <dl class="mb-0">
                            ...
                            <dd class="d-flex form_input">                    
                                <input type="text" style="background: #fff;" id="keyin_Tid" bind:value={userData.store_wallet.ki_catId} class="input cat_id" name="keyin_tid" maxlength="15">
                    ...
                    <div class="col-12 col-md-5 col-lg-5">
                        <dl class="flex_d" style="margin-bottom: 0;">
                            ...
                            <dd class="d-flex form_input">
                                <input type="text" style="background: #fff;" class="input key_input_t" id="keyin_paykey" name="keyin_paykey"/> 
                    ...
                    <div class="row store_edit_row" id="tertidtitle">
                        ...
                        <div class="col-12 col-md-6 col-lg-5">
                            <dl class="mb-0">
                                ...
                                <dd class="d-flex form_input">                    
                                    <input type="text" id="terminal_Tid" style="background: #fff;" bind:value={userData.store_wallet.T_catId} class="input cat_id" name="terminal_Tid" maxlength="15" >       
